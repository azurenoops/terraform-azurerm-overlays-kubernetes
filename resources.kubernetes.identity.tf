...
resource "azurerm_role_assignment" "aks_identity_contributor" {
  ...
  scope                 = "/subscriptions/def76464-cef6-4c3b-9728-8952072734eb/resourceGroups/tf-anoa-public-aks-rg/providers/Microsoft.Network/routeTables/rt-aks_egress" #azurerm_route_table.rt.id
}
