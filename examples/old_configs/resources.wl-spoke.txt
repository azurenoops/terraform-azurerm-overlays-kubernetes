...
module "aks_network" {
  ...
  location              = var.aks_vnet_location
  deploy_environment    = var.aks_deploy_environment
  org_name              = var.aks_vnet_org_name
  environment           = var.aks_vnet_environment
  workload_name         = var.aks_vnet_workload_name
...
output "aks_resourse_group_name" {
