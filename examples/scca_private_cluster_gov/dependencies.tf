...
resource "azurerm_virtual_network_peering" "aks_spoke_to_hub" {
  ...
  virtual_network_name                = azurerm_virtual_network.aks_vnet.name
  remote_virtual_network_id           = "/subscriptions/ENTER_SUB_ID/resourceGroups/tf-anoa-usgaz-hub-core-dev-rg/providers/Microsoft.Network/virtualNetworks/tf-anoa-usgaz-hub-core-dev-vnet"
}
...
resource "azurerm_virtual_network_peering" "hub_to_aks_spoke" {
  ...
  remote_virtual_network_id = "/subscriptions/ENTER_SUB_ID/resourceGroups/tf-anoa-gov-rg-aks/providers/Microsoft.Network/virtualNetworks/vnet-aks"
}
